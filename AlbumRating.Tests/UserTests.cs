namespace AlbumRating.Tests
{
    ...
    public class UserTests
    {
        ...
        public void AddUserInDatabase()
        {
            ...
            {
                new User{ UserName = "a@abv.bg"},
                new User{ UserName = "b@abv.bg"},
                new User{ UserName = "c@abv.bg"}
            ...
            Assert.AreEqual("a@abv.bg", users[0].UserName);
            Assert.AreEqual("b@abv.bg", users[1].UserName);
            Assert.AreEqual("c@abv.bg", users[2].UserName);
        }
